                     ...
                     <div class="box_img_pareja">
                       ...
                       <div class="box_img center-block clearfix">
                         ...
                         <!--   <img class="img-responsive" src="https://api.fnkr.net/testimg/1920x800/00CED1/FFF/?text=img+placeholder"> -->
                           <img id="icon" src="<?php bloginfo('template_url'); ?>/assets/img/ico_rol.png">
                       </div><!-- box_img  -->
      ...
      <div class="row  ">
        <div class="suenos clearfix no-gutter">
          <div class="col-sm-12 col-md-4">
                <h4>casa</h4>
              <a id="casa" href="" >
                  <img src="<?php bloginfo('template_url'); ?>/assets/img/casa.png" alt="" class="center-block img-responsive">
              </a>
          </div>
          <div class="col-sm-12 col-md-4">
          <h4>viaje</h4>
              <a id="viaje" href="" class="">
                  <img src="<?php bloginfo('template_url'); ?>/assets/img/viaje.png" alt="" class="center-block img-responsive">
              </a>
          </div>
          <div class="col-sm-12 col-md-4">
          <h4>estudio</h4>
              <a id="estudio" href="" class="mb0">
                  <img src="<?php bloginfo('template_url'); ?>/assets/img/estudio.png" alt="" class="center-block img-responsive">
              </a>
          </div>
        </div>
        <div class="col-sm-12 text-center">
